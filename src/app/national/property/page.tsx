...
export default function NationalPropertyPage() {
    ...
    const fetchStationProperties = async (stationId: number) => {
        ...
        try {
            ...
            const response = await fetch(`/api/properties/network?station_id=${stationId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
            ...
            <div className="pt-12">
                ...
                <div className="mt-6 max-w-2xl mx-auto">
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder="Search stations by name, location, or station code..."
                            ...
                            <div key={station.station_id} className="glass-card p-4 hover:border-primary/50 transition-all group cursor-pointer" onClick={() => handleViewStation(station)}>
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between text-xs">
                                        <span className="text-muted">Station Code:</span>
                                        <span className="text-white font-mono">{station.station_code}</span>
                                    </div>
                                    <div className="flex items-center justify-between text-xs">
